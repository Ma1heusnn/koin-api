...
import db.tables.refresh.RefreshTokensTable
import security.TokenConfig
import security.generateAccessToken
...
class RefreshTokenService(private val tokenConfig: TokenConfig) {
    ...
    companion object {
        ...
        // Application.module): mover para config exigiria replicar a property no MapApplicationConfig dos
