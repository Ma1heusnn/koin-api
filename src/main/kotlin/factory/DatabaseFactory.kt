...
object DatabaseFactory {
    ...
    fun init(dataSource: DataSource) {
        ...
        // src/main/resources/db/migration (V1__baseline.sql). Flyway e Exposed usam o MESMO
    ...
    // H6: seed exposto como suspend, chamado do module() FORA de qualquer transaction {}.
