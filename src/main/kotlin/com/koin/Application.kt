...
import com.koin.plugins.configureStatusPages
...
fun Application.appModule(dataSource: DataSource) {
    ...
    // H6: seed FORA de transação, no nível do boot. com.koin.module() não é suspend, então o runBlocking AQUI
